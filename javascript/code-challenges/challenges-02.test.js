...
const raisedToTheThird = (arr) => {
  // Solution code here...
  return arr.map(numbs => {
    return Math.pow(numbs,3);
  });
  // const toTheThirs = [];
  // arr.array.forEach(numbs => {
  //   toTheThirs.push(Math.pow(numbs,3));
  // });
  // return toTheThirs;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let numbs of arr){
    loop.push(Math.pow(2,numbs));
  }
  return loop;

  // for (let i =0; i< arr.length; i++) {
  //   let arr = arr[i];
  //   let twoToThe = (Math.pow(2, arr));
  //   loop.push(twoToThe);
  // }
  // return loop;
};
...
const forEachTwoToThe = (arr) => {
  ...
  const twoToThe = [];
  arr.forEach(numbs => {
    twoToThe.push(Math.pow(2, numbs));
  });
  return twoToThe;
};
